  ...
  return (
    <>
      <section className="container mx-auto py-12 px-4 text-center">
        ...
        <button className="mt-8 rounded-3xl bg-primary px-6 py-3 text-lg font-semibold text-white hover:bg-blue-700" onClick={handleContactUsClick} data-gtm="contact-us-button">
          Contact Us
        </button>
      </section>
      {showDetailsPopup && (
