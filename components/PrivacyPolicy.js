...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto my-8 px-6 min-h-screen">
      <div className="text-sm text-justify p-6 bg-white">
        <h1 className="text-3xl font-bold text-primary mb-6">Privacy Policy</h1>
        <p className="text-primaryBlack mb-4">Effective Date: January 5, 2023</p>
...
Affiliates and subsidiaries: We may share your personal information within the Tantun Holdings Insurance group of companies, which includes parents, corporate affiliates, subsidiaries, business units and other companies that share common ownership for the purposes described above.
...
10. Your Rights
Upon request, Tantun Holdings will provide you with information about whether we hold any of your personal information. If your personal information changes, or if you otherwise want to correct, update, delete, or make other requests regarding your data (such as limiting sharing with non-affiliates), you may call us toll free at[Phone NUmber] or by mail at:
...
Identifiers, such your name, alias, postal address, telephone number, unique personal identifier, email address, phone number, or other similar identifiers.
...
Records about you, such as estimated income, financial information, and other demographic information we receive from data brokers.
·  Affiliates and subsidiaries
·  Third party service providers
·   For legal, security, and safety purposes
·   In connection with a corporate transaction
...
·  In connection with a corporate transaction
·  Entities to which you have consented to the disclosure
Geolocation data, limited to your address.
·  Affiliates and subsidiaries
·  Third party service providers
·  For legal, security, and safety purposes
·  In connection with a corporate transaction
...
·  In connection with a corporate transaction
·  Entities to which you have consented to the disclosure
Sensitive personal information, such as health information and racial or ethnic origin.
·  Affiliates and subsidiaries
·  Third party service providers
·  For legal, security, and safety purposes
·  In connection with a corporate transaction
...
Your Rights
Subject to legal limitations and exceptions, California residents may exercise the following rights by calling us toll free at [fill a phone number] or by using our webform:
