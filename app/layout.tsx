...
export const metadata: Metadata = {
  title: "Medicare Plans Insurance Assistance - Find the Best Medicare Plan",
  description:
    "Get Medicare Licensed Agent enrollment guidance based on your preferred doctors, prescriptions, and dental coverage. Contact us today!",
  openGraph: {
    title: "Medicare Insurance Plans Assistance - Find the Best Medicare Plan",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Medicare Plans assistance experts ready to help",
      },
    ],
    type: "website",
  },
